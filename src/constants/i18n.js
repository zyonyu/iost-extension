const enTranslation = {
  ...
  ChangeNode_Invalid_Address: 'Please Enter A Correct Address',
  ChangeNode_Node_Exist: 'Node Already Exist',
  ChangeNode_Default_Node: 'Default Node',
  ChangeNode_Error: 'Error',
  ChangeNode_Head_Block: 'Block Height',
  ChangeNode_Custom_Node: 'Custom Node',
...
const koTranslation = {
  ...
  CreateAccount_Tip3:
    'IOST 네트워크에서 새 계정을 만드는 데는 약 100 IOST가 소요됩니다. 그것은 iGAS 요금을 얻기 위해 0.98K iRAM을 구입하는 데 사용됩니다.',
  ...
  ChangeNode_Invalid_Address: '정확한 주소를 입력해주세요',
  ChangeNode_Node_Exist: '노드가 이미 존재합니다',
  ChangeNode_Default_Node: '기본 노드',
  ChangeNode_Error: '오류',
  ChangeNode_Head_Block: '블록 높이',
  ChangeNode_Custom_Node: '커스텀 노드',
...
const jaTranslation = {
  firstLogin_SetPassword: 'ウォレット用パスワードを入力してください',
  firstLogin_RepeatPassword: 'パスワードを再入力してください',
  firstLogin_CreateAccount: 'アカウントを作る',
  firstLogin_ImportAccount: '秘密鍵をインポートする',
  firstLogin_NoAndCreate1: 'アカウントを持っていませんか？',
  firstLogin_NoAndCreate2: 'サードパーティ製です（IOST公式ではありません）',
  firstLogin_AgreementTip1: 'このウォレットを利用することは',
  firstLogin_AgreementTip2: '利用規約に同意したとみなされます',
  firstLogin_AgreementTip3: '利用規約に同意してください',
  Password_Length: 'パスワードは8文字以上にしてください！',
  Password_Combination: 'パスワードは少なくとも英字と数字を含んでください！',
  Password_Different: 'パスワードが合致しません！',
  Password_TryAgain: '不正なパスワードです、再入力してください！',

  CreateAccount_AccountName: 'IOSTアカウント名を入力してください',
  CreateAccount_Tip1: '小文字英字と数字から構成される5-11文字で入力してください',
  CreateAccount_QueryStatus: 'アカウントの文字列が不適切です',
  CreateAccount_AccountExist: '同じアカウント名が既に存在します',
  CreateAccount_NextStep: '次の手順',
  CreateAccount_ConfirmPrivate: '秘密鍵のペアを確定させる',
  CreateAccount_Tip2: 'アカウントに関する情報を確定させてください。クリックして編集できます。',
  CreateAccount_OwnerPublicKey: '所有者の公開鍵',
  CreateAccount_ActivePublicKey: 'アクティブな公開鍵',
  CreateAccount_OwnerPrivateKey: '所有者の秘密鍵',
  CreateAccount_ActivePrivateKey: 'アクティブな秘密鍵',
  CreateAccount_ChangePrivateKey: '秘密鍵ペアの変更',
  CreateAccount_ToastTip1: '秘密鍵が間違っています',
  CreateAccount_Pay: '支払う',
  CreateAccount_Tip3: '新しいIOSTアカウント作成のためには100IOSTのコストが必要です（0.98KBのiRAM購入費用とiGAS費用）',
  CreateAccount_Tip4: '支払方法を選んでください',
  CreateAccount_PaymentCurrency: '支払い通貨',
  CreateAccount_PaymentAddress: '支払いアドレス',
  CreateAccount_CheckCreate: 'アカウント作成状況を確認',
  CreateAccount_ToastTip2: 'アカウントはまだ出来ていません',
  CreateAccount_ToastTip3: 'アカウントはの作成に成功しました',

  ImportAccount_EnterPrivate: 'アカウントの秘密鍵を入力',
  ImportAccount_EnterName: 'ローカルのアカウント名を入力',
  ImportAccount_Submit: '送信',
  ImportAccount_Completed: 'インポート完了',
  ImportAccount_Failed: 'インポート失敗、もう一度お試しください',
  ImportAccount_LocalNetMessage: 'ローカルアカウントのインポートのために、アカウント名を入力してください',
  ImportAccount_Tip1: '該当アカウントがありません',
  ImportAccount_Tip2: '秘密鍵は空欄にできません',
  ImportAccount_Tip3: '該当する公開鍵がありません',
  Account_Transfer: '送信',
  Account_Receive: 'デポジット',
  Account_Transaction: 'トランザクションの記録',
  Account_Confirmed: '完了',
  Account_NotApproved: '非承認',
  Account_Failed: '失敗',
  Account_AddToken: 'トークン追加',

  Transfer_Amount: '送金量',
  Transfer_Balance: '残高: %{num} %{token}',
  Transfer_InputAmount: '入力アカウント',
  Transfer_Payee: '手数料',
  Transfer_EnterName: '有効なIOSTアカウントを入力してください',
  Transfer_Note: 'メモ',
  Transfer_Optional: 'オプション',
  Transfer_Resource: 'リソース料金',
  Transfer_Submit: '送信',
  Transfer_Tip: 'もし、リソースが足りない場合は、IOSTの一部をデポジットして転送を完了させるようサポートします',
  Transfer_Choose: 'トークン選択',

  Receive_Title: 'このアドレスは、IOSTブロックチェーン上のトークンのみを受け付けます',
  Receive_Copy: '支払いアドレスをコピー',
  Receive_Tip: '* 今は xxx ウォレットをサポートしています',
  Settings_Title: '設定',
  ...
  Settings_iostWallet: 'iWalletについて',
  Settings_assetManage: '資産管理',
  Settings_developerMode: '開発者モード',

  ManageAccount_Add: 'インポート',
  ManageAccount_PublicKey: '公開鍵',
  ManageAccount_PrivateKey: '秘密鍵',
  ManageAccount_Official: 'メインネット',
  ManageAccount_Local: 'ローカルネット',
  ManageAccount_Test: 'テストネット',
  ManageAccount_Copy: 'コピー成功',
  ManageAccount_Delete: '削除してよろしいですか？',
  ManageAccount_DeleteTip: 'アカウントを削除する前に、必ず秘密鍵がバックアップされていることを確認してください',
  ManageAccount_Confirm: '確定',
  AccountAdd_Title: 'アカウント追加',
  ChangeLanguage_china: '中国語',
  ChangeLanguage_english: '英語',
  ChangeLanguage_korea: '韓国語',
  ChangeLanguage_japan: '日本語',
  ChangePassword_CurrentPassword: '現在のパスワードを入力',
  ChangePassword_Verification: '認証完了',
  ChangePassword_NewPassword: '新しいパスワードを入力',
  ChangePassword_Repeat: '再入力',
  ChangePassword_Wrong: 'パスワードが間違っています、再入力してください',
  Lock_EnterPassword: 'パスワード入力',
  Lock_Unlock: 'ウォレットロック解除',
  AboutIOST_nodeVoting: 'ノード投票に参加',
  AboutIOST_userAgreement: '利用規約',
  AboutIOST_developerMode: '開発者モード',

  AssetManage_TokenName: 'トークン名',
  AssetManage_Add: '追加',
  AssetManage_AddSuccess: '追加しました！',
  AssetManage_AddExisted: '既に存在しています',
  AssetManage_AddNotFound: 'トークンが見つかりません',
  AssetManage_MyAsset: '自己資産',

  TokenDetail_Full: 'トークン正式名称',
  TokenDetail_Detail: '詳細',
  ...
  RamManage_Title: 'iRAMリソース管理',
  RamManage_Used: '使用中',
  RamManage_Remaining: '残高',
  RamManage_Buy: '購入',
  RamManage_Sell: '売却',
  RamManage_PurchaseAmount: '購入数量（KB）',
  RamManage_PurchasePrice: '購入価格',
  RamManage_PurchaseEnter: '購入数量を入力',
  RamManage_Address: 'リソース受取アドレス',
  RamManage_Optional: 'オプション、通常は自分のアドレス',
  RamManage_SellAmount: '売却数量（KB）',
  RamManage_SellPrice: '売却価格',
  RamManage_SellEnter: '売却数量を入力',

  GasManage_Title: 'iGASリソース管理',
  GasManage_Lock: 'ロック中',
  GasManage_Locked: 'ロック中',
  GasManage_Available: '利用可能',
  GasManage_Stake: '補充',
  GasManage_Stakeing: '補充中',
  GasManage_UnStake: '補充解除',
  GasManage_CanUnStake: '利用可能',
  GasManage_UnStakeing: '補充解除',
  GasManage_StakeAmount: '補充量',
  GasManage_UnStakeAmount: '補充解除量',
  GasManage_Balance: '残高',
  GasManage_StakeEnter: '数量入力',
  GasManage_StakeAddress: 'リソース受領アドレス',
  GasManage_UnStakeAddress: 'リソース補充解除アドレス',
  GasManage_Optional: 'オプション、通常は自分のアドレス',
  GasManage_Tip: '* 補充解除したIOSTは 72時間経過するまで、利用できません',
  GasManage_Records: 'リソース管理記録',
  GasManage_Records_Item: '補充 iGAS は %{name}',

  transferResult: '送金結果',
  transferSuccess: '送金成功',
  transferFailed: '送金失敗',
  transferFailedTip: '送金失敗のヒント',
  txid: 'Tx ID',
  gasUsage: 'iGAS利用量',
  transferClose: '閉じる',
  ...
  ChangeNode_Invalid_Address: '正しいアドレスを入力してください',
  ChangeNode_Node_Exist: 'ノードはすでに存在しています',
  ChangeNode_Default_Node: 'デフォルトノード',
  ChangeNode_Error: 'エラー',
  ChangeNode_Head_Block: 'ブロックの高さ',
  ChangeNode_Custom_Node: 'カスタムノード',
